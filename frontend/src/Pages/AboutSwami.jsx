...
const AboutSwami = () => {
  return (
    <div className="bg-[#F5CCA0] text-gray-900 font-sans">
      <Head />
      <center>
        <h1 className="text-4xl font-bold text-[#994D1C] my-16">About Swami</h1>
      </center>
      <div className="m-5 text-justify text-lg leading-relaxed">
        <p>
        ...
        <br />
        <p>
          Later Shri Shivananda Paramahamsar travelled entire Bharat and also to Singapore, Burma, Thailand, Malaysia etc, initiated around 6 lakhs people into Siddha Vidya. He established Siddha Samaj at Vatakara or Badagara as main center and Kayanna, Iyyuru, Mannurkara, Ammampalayam (Tamilnadu) as branches.
        </p>
        <br />
        <p>
      ...
      <footer className="bg-[#994D1C] text-white py-5 text-center mt-20">
        ...
        <p className="text-sm mt-4">&copy; 2024 Chennai Siddhavidhai Trust. All Rights Reserved</p>
      </footer>
    </div>
  );
};
